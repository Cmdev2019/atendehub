...
// Ícones SVG do projeto — fonte: svgrepo.com (https://www.svgrepo.com),
// coleção "Tabler Icons" (licença MIT):
// https://www.svgrepo.com/collection/tabler-icons/
//
// Convenção: TODO ícone novo deve vir do svgrepo.com — preferir esta mesma
// coleção para manter o traço consistente (24x24, stroke 2, cantos redondos).
// Cada entrada guarda apenas o corpo do SVG; os atributos comuns ficam no
// componente Icon abaixo.
const ICONS = {
  ...
  'funnel': '<path d="M4 4h16v2.172a2 2 0 0 1 -.586 1.414l-4.414 4.414v7l-6 2v-8.5l-4.48 -4.928a2 2 0 0 1 -.52 -1.345v-2.227" />',
  ...
  'clipboard': '<path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" /><path d="M9 5a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2" /><path d="M9 12h6" /><path d="M9 16h6" />',
